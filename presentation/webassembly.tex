...
\begin{frame}{What is WebAssembly?}
    ...
    \begin{itemize}
        ...
        \item Original specification covered an asseblylike language, \textbf{WebAssembly Text}, as well as the \textbf{WebAssembly Binary} Format
...
\begin{frame}{Additional Information}
    \begin{itemize}
        ...
        \begin{itemize}
            \item **SharedArrayBuffer** caused Spectre in 2018, which resulted in multithreading being **removed** 
            \item SharedArrayBuffer being **added** gradually to browsers **again**
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Security}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{No} - Module is stopped immeadiately 
        \end{itemize}
    \end{itemize}
    \end{itemize}
    \end{frame}
