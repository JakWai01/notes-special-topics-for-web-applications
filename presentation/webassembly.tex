...
\begin{frame}{Security}
    ...
    \item Permissions are required to access hardware of filesystem
    \item Can't access DOM 
    \item Dedicated memory space
    \item Prohibit unwanted memory access
    \item Protect execution stack
    \item Tables 
    \item Removing unsafe features while being compatible with C/C++
    \item Traps
    \end{itemize}
\end{frame}
