...
\begin{frame}{Efficient and fast - Reoptimizaion}
    ...
    \begin{itemize}
        ...
        \item Reoptimization happens when variables in a loop are different than they were in previous iterations
...
\begin{frame}{Effecient and fast - Execution}
    ...
    \begin{itemize}
        ...
        \item Near native speed (60-70\% in a C++ analysis). Causes for decreased speed:
        \begin{itemize}
        ...
        \end{itemize}
        \item Most of the time, still a speedup up to 800\% compared to JavaScript
    \end{itemize}
\end{frame}
